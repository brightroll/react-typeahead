...
var TypeaheadSelector = React.createClass({displayName: "TypeaheadSelector",
  ...
  componentDidMount: function() {
    if (this.props.intialValue !== null) {
      var index = this.props.options.indexOf(this.props.initialValue);
  ...
  componentDidUpdate: function() {
    if (this.state.selectionIndex !== null) {
      ...
      var menuDOM = this.refs.results.getDOMNode();
  ...
  render: function() {
    ...
    return React.createElement("ul", {ref: "results", className: classList, onBlur: this.props.onListBlur},  results );
  },
